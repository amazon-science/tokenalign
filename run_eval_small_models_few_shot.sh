...
model_names="codegen-16B-mono codegen-16B-multi codegen-6B-mono codegen-6B-multi codegen-2B-mono codegen-2B-multi codegen-350M-mono codegen-350M-multi"
datasets="mbjsp"
...
for dataset in $datasets; do
    ...
    for model_name in $model_names; do
        ...
        --output_dir ./eval_results_few_shot/$dataset/$model_name/$policy/ \
